...
from .views import PostList, NewsCreate, ArticleCreate, PostUpdate, NewsList, ArticleList, NewsDetail, ArticleDetail, PostDelete
...
urlpatterns = [
   ...
   path('news/<pk>', NewsDetail.as_view(), name='post_detail'),
   path('article/<pk>', ArticleDetail.as_view(), name='post_detail'),
